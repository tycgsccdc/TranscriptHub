...
<body>
   ...
   <main class="main-content">
      ...
      <div class="container">
         ...
         <div class="headerx">
            <h1>中研院 AI 服務平台—逐字稿使用條款</h1>
            <div class="version">版本：2025.2.7</div>
            <div class="department">中央研究院資訊服務處</div>
         </div>
         <div>
            <h2>一、適用範圍</h2>
            ...
            <h2>二、服務內容</h2>
            <p>本服務提供將錄音檔案內容轉換為逐字稿的功能，用戶可將資料上傳至本院指定平台，系統將自動產生文字檔案。本服務旨在提高工作效率，僅供合
法及
內部業務用途。</p>
            ...
            <h2>四、保密與隱私</h2>
            <ol>
               <li>本院對用戶上傳的資料將採取嚴格保密措施，僅用於提供本服務所需，不會另作他用。</li>
               <li>本院承諾未經用戶許可，不會將資料分享給第三方，法律另有規定者除外。</li>
               <li>用戶上傳的錄音檔案轉出為逐字稿後將立刻刪除，轉出的逐字稿將保留1個月後刪除。</li>
            </ol>

            <h2>五、逐字稿準確性</h2>
            <p>本服務所產生的逐字稿為系統自動生成，其準確性可能受錄音檔案內容的音質、錄製速度等因素影響，並可能無法正確識別領域專有名詞。本院不對
逐字
稿的完整性或正確性作出保證，用戶應自行核對並確認內容。</p>

            <h2>六、智慧財產權</h2>
            <ol>
               <li>本服務所涉及的軟體、技術及相關內容之所有權與智慧財產權均屬本院所有。</li>
               <li>用戶僅享有本服務授予的有限使用權，不得以任何形式擅自複製、修改、散佈或衍生使用。</li>
            </ol>

            <h2>七、服務限制與終止</h2>
            <ol>
               <li>本院保留在必要時限制或暫停用戶訪問本服務的權利，無需事先通知。</li>
               <li>用戶違反本條款或法律規定時，本院有權立即終止其使用資格。</li>
            </ol>

            <h2>八、責任限制</h2>
            <ol>
               <li>本服務按"現狀"提供，本院不對服務的不中斷性或無誤性作任何保證。</li>
               <li>對於因使用本服務而產生的任何直接、間接或後果性損失，本院概不承擔責任。</li>
            </ol>

            <h2>九、條款修改</h2>
            <p>本院保留隨時修改本條款的權利，修訂後的條款將通過本服務平台公告，用戶繼續使用本服務即視為同意修訂內容。</p>
