    ...
    <div class="container">
        ...
        <div class="features">
           <div class="feature-itemx translate">
              ...
              <div class="feature-text">AI Translation</div>
           </div>
           <a href="/www/en/translate">
           <div class="feature-item subtitle">
              <div class="feature-icon"><img src="/images/transcription.svg"></div>
              <div class="feature-text">AI Transcription (Beta)</div>
           </div>
           </a>
<!--
           <div class="feature-itemx summary">
              <div class="feature-icon"><img src="/images/summary-gray.svg"></div>
              <div class="feature-text">AI Summary</div>
           </div>
-->            
            <div class="feature-itemx assistant">
               <div class="feature-icon"><img src="/images/litterhelp-gray.svg"></div>
               <div class="feature-text">AI Assistant</div>
            </div>
        </div>
        <div class="divid">
